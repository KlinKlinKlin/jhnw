...
public class SwitchProblemServiceImpl implements ISwitchProblemService 
{
    ...
    @Override
    public List<SwitchProblemVO> selectUnresolvedProblemInformationByData(String currentTime) {
        return switchProblemMapper.selectUnresolvedProblemInformationByData(currentTime);
    }
}
